              ...
              <div className="relative">
                ...
                <div className="relative bg-card p-6 rounded-2xl border shadow-xl space-y-6">
                  <img
                    src="/app/profile.jpg"
                    alt="Profile"
                    className="w-full aspect-[4/3] object-cover rounded-lg max-w-[320px] mx-auto"
                  />
        ...
        <div className="container px-4 md:px-6 mx-auto text-center">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-background rounded-2xl border shadow-xl overflow-hidden">
              ...
              <div className="p-0">
                <iframe
                  src="https://udify.app/chatbot/tS3LXPogvMbvWA1A"
        ...
        <div className="container px-4 md:px-6 mx-auto">
          ...
          <div className="space-y-12 max-w-3xl mx-auto">
            {[
              {
                company: "字节跳动",
                position: "AI数据技术实习生（评测）",
                project: "豆包 - 超能Agent",
                period: "2025.09 - 至今",
                description: "核心职责： 负责大模型及 Agent 能力评估体系的搭建，涵盖高质量测试集构建、自动化评估工具开发及评估流程的平台化转型，为算法迭代与产品上线提供数据决策支持。（1）构建用于超能Agent可复用的评测集：负责超能Agent 与 AI Slides 的测试集建设，搭建从任务分类体系、数据采集、Prompt 标注到样本设计与分布控制的完整评测流程。设计评测标签体系与样本分布策略：基于回流数据、行业研究、O*Net 职业库及产品场景等多源信息构建标签体系，并制定样本分布规划，按配额构建覆盖核心场景的高质量评测集，确保测试集的数据代表性与评估稳定性。落地高质量评测数据生产：参与超能 3.0 评测集构建，负责 AI Slides 端到端评测集构建；主导 1.6 万条合成数据生成，设计“LLM 预标注 + 人工质检”的 Human-in-the-loop 流程，并通过 Prompt 优化显著提升数据产出效率与标注一致性。支撑自动与人工评估体系：测试集被其他 3 个团队复用，用于自动化评估和人工评估；结合人工评估结果产出竞品分析，识别模型在指令遵循、工具调用等核心能力的优势与短板，为新模型发版和能力迭代提供决策依据。（2）自动化评估体系搭建：调研并筛选适配业务场景的开源 benchmark，团队成功接入 WebVoyager 至内部 Merlin 平台，补齐团队在 AI 浏览器方向的自动化基准测试能力。设计 Eval-Tool 自动化评估方案，迭代核心 Prompt，配合开发解析 Agent 的思考链与工具调用轨迹，实现模型调用工具能力的深度诊断；评估结果反向优化工具接口，提升模型对工具指令的理解准确率。v1.0 已完成，后续将根据 Agent 能力迭代推进 v2.0。（3）人工评估平台化与工具提效：推动评估作业从线下表格迁移至线上平台，组织评估同学完成平台上评估的测试并验证关键流程，明确作业卡点5条与需求，对接开发与平台产品推进流程；参与设计线上评估看板，构建人效统计、模型效果对比等指标，实现评估数据闭环管理与可视化。实现 结论校验机器人与 PPT 结论图分类工具，将人工质检经验转化为自动化规则（Prompt 校验），校验格式与逻辑错误，显著降低人工复检成本并提升评测结论可信度。",
